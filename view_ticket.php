			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								<label for="" class="control-label border-bottom border-primary">Customer Name</label>
								<p class="ml-2 d-list"><b><?php echo $cname ?></b></p>
								<label for="" class="control-label border-bottom border-primary">Contact No</label>
								...
								<label for="" class="control-label border-bottom border-primary">Product Type</label>
								<p class="ml-2 d-list"><b><?php echo $dname ?></b></p>
								<label for="" class="control-label border-bottom border-primary">Model No</label>
